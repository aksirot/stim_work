...
SYM_DIR   = RUNS / "bravyi" / "bb6" / "bb6_fig10_curve"    # symmetric  (p_meas = p_phys)
MEAS5_DIR = RUNS / "bravyi" / "bb6" / "bb6_meas5x_curve"   # 5x-meas    (p_meas = 5 x p_phys)
...
out = REPO_ROOT / "notebooks" / "bravyi" / "bb6" / "BB6_meas_comparison.ipynb"
