...
code('''import sys, numpy as np, matplotlib.pyplot as plt
...
FULL_DIR = RUNS / "bravyi" / "bb6" / "bb6_fulldem_curve"      # full both-sector DEM results
SINGLE_DIR = RUNS / "bravyi" / "bb6" / "bb6_fig10_curve"      # single Z-sector results (for the comparison)
...
out = REPO_ROOT / "notebooks" / "bravyi" / "bb6" / "BB_failfast_fulldem_report.ipynb"
