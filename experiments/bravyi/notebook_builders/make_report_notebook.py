...
_t = time.time()
R = bb6_report.compute()              # loads runs/bravyi/bb6/bb6_fig10_curve/ (DEFAULT_OUT), fits f3 & f5
print(f"loaded bb6_fig10_curve in {time.time()-_t:.0f}s — "
...
out = REPO_ROOT / "notebooks" / "bravyi" / "bb6" / "BB6_failfast_report.ipynb"
